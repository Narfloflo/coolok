 ...
 */
final class Version20220114091329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matching DROP matching_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matching ADD matching_at DATETIME NOT NULL');
    }
}
